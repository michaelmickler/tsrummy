...
export interface ICardProps { card?: mCard; children?: any; css?: any; }
export interface ICardMarkProps { card: mCard; type: 'left' | 'right'; }
...
export const Card: React.FC<ICardProps> = ({ children, card, css }) => {
  
  return <div className="Card" style={{ ...(css || {}), }}>
